...
const IndividualGroup = () => {
  ...
  // Handle voice commands for modal navigation
  useEffect(() => {
    const handleVoiceCommand = (event: CustomEvent) => {
      console.log('Voice command received in IndividualGroup:', event.detail);
    ...
    <div>
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          {/* Sort Controls */}
          <div className="flex gap-2 overflow-x-auto w-[90vw] md:w-full justify-start md:justify-end md:ml-auto">
            {[
